...
import (
	...
	pbmpshared "github.com/the729/go-libra/generated/pbmpshared"
...
type SubmitTransactionRequest struct {
	...
	SignedTxn            *pbtypes.SignedTransaction `protobuf:"bytes,1,opt,name=signed_txn,json=signedTxn,proto3" json:"signed_txn,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                   `json:"-"`
	XXX_unrecognized     []byte                     `json:"-"`
	XXX_sizecache        int32                      `json:"-"`
}
...
func (m *SubmitTransactionRequest) GetSignedTxn() *pbtypes.SignedTransaction {
	if m != nil {
		return m.SignedTxn
	}
	return nil
...
type SubmitTransactionResponse_MempoolStatus struct {
	MempoolStatus *pbmpshared.MempoolAddTransactionStatus `protobuf:"bytes,3,opt,name=mempool_status,json=mempoolStatus,proto3,oneof"`
}
...
func (m *SubmitTransactionResponse) GetMempoolStatus() *pbmpshared.MempoolAddTransactionStatus {
...
var fileDescriptor_d13d6ff9aac892b4 = []byte{
	...
	,
}
